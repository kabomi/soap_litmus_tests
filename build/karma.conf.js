...
module.exports = function(config) {
  config.set({
    ...
    files: [
        'src/client/assets/javascript/jquery-*.js',
        'src/client/app.js',
    ...
    reporters: (process.env.BERLIN_DEPLOY?['progress']:['progress', 'osx']),
    ...
    browsers: (process.env.BERLIN_DEPLOY?['PhantomJS']:['PhantomJS', 'Safari']),
